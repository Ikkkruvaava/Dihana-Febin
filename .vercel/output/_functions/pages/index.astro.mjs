...
import { $ as $$Image } from '../chunks/_astro_assets_CNW_GREQ.mjs';
import { $ as $$Card } from '../chunks/Card_prvYPjm4.mjs';
import 'clsx';
import { l as larrow } from '../chunks/icon3_BaJI8FUy.mjs';
/* empty css                                 */
import { c as createSvgComponent, $ as $$MainLayout } from '../chunks/MainLayout_CEmZLZgm.mjs';
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Section.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/ui/SectionTitle.astro", void 0);

const $$Cases = createComponent(($$result, $$props, $$slots) => {
  const cards = [
    {
      index: 0,
      title: "Social Media Growth Campaign \u2014 Managed and grew Instagram and Facebook accounts for a local brand, resulting in increased engagement through consistent content calendars and creative reels.",
      link: "#contact"
    },
    {
      index: 1,
      title: "SEO Content Strategy \u2014 Developed and executed an SEO-driven content plan that improved organic visibility and website traffic for a client through targeted keyword content.",
      link: "#contact"
    },
    {
      index: 1,
      title: "Meta Ads Campaign \u2014 Planned and ran a paid Meta Ads campaign for a business, tracking performance and optimizing for improved reach and lead generation results.",
      link: "#contact"
    }
  ];
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "work" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "My Work", "description": "Real projects. Real results." })} ${maybeRenderHead()}<div class="flex flex-col lg:flex-row justify-between rounded-[45px] p-1"> ${cards.map((card) => renderTemplate`${renderComponent($$result2, "Card", $$Card, {}, { "default": ($$result3) => renderTemplate` <div class="flex p-[60px] h-full bg-dark text-gray rounded-[45px] m-[1px]"> <div class="flex flex-col gap-5"> <p>${card.title}</p> <a${addAttribute(card.link, "href")} class="flex items-center gap-[15px]"> <span class="text-green">View Details</span> <picture> ${renderComponent($$result3, "Image", $$Image, { "src": larrow, "alt": "Arrow pointing up right" })} </picture> </a> </div> </div> ` })}`)} </div> ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Cases.astro", void 0);
...
const decorForm = new Proxy({"src":"/_astro/contact-pic.BrB0SfUf.png","width":692,"height":649,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/assets/pics/contact-pic.png";
							}
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "home" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="relative flex flex-col-reverse items-center md:flex-row" id="hero"> <div class="row items-center py-5 md:w-6/12 md:pb-20 md:pt-10"> <div class="text-left space-y-3"> <h1 class="text-4xl font-medium leading-none md:text-6xl text-center md:text-left">Hi, I'm Dihana — <br> A <span class="greenhead">Digital Marketer</span> <br> Who Makes Brands <br> Actually Connect.</h1> <p class="mt-6 mb-8 text-lg font-normal leading-7 sm:mb-12 text-center md:text-left md:pr-12">Strategy. Creativity. Results That Grow. I blend SEO, Meta Ads, content, and design to build brand presence that people actually notice.</p> <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-start"> <a href="#work" class="px-8 py-5 bg-zinc-900 hover:bg-white rounded-2xl text-center text-white hover:text-black border text-xl font-normal leading-7">View My Work</a> <a href="#contact" class="px-8 py-5 bg-transparent hover:bg-zinc-900 rounded-2xl text-center text-black hover:text-white border border-zinc-900 text-xl font-normal leading-7">Let's Connect</a> </div> </div> </div> <div class="flex items-center py-5 md:w-6/12 md:pb-20 md:pt-10"> ${renderComponent($$result2, "Image", $$Image, { "src": HeroIlust, "alt": "Digital Marketing Illustration", "loading": "eager" })} </div> </div> ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Hero.astro", void 0);
  ...
  const content = [
    {
      ...
      description: "We start with a conversation. I learn about your brand, your goals, your audience, and what you've tried before. This gives me the full picture before I touch anything."
    },
    {
      index: 2,
      title: "Research & Strategy",
      description: "I dive deep into your industry, competitors, and audience. Then I build a clear marketing strategy \u2014 the roadmap for everything we'll do together."
    },
    {
      index: 3,
      title: "Content & Creative",
      description: "I get to work \u2014 designing graphics, writing copy, creating reels, and building the creative assets your brand needs to stand out."
    },
    {
      index: 4,
      title: "Launch & Execute",
      description: "Campaigns go live. Content gets published. Ads start running. I manage everything to make sure execution is smooth and on-brand."
    },
    {
      index: 5,
      title: "Track & Optimize",
      description: "I monitor performance daily \u2014 tracking metrics, analyzing what's working, and making real-time adjustments to maximize results."
    },
    {
      index: 6,
      title: "Report & Refine",
      description: "You get a clear, easy-to-understand report on what happened, what worked, and what we'll do even better next time."
    }
  ];
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/ui/Accordion.astro", void 0);

const $$Process = createComponent(($$result, $$props, $$slots) => {
  const description = "My step-by-step approach to growing your brand online.";
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "process" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mt-[140px]"> ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "How I Work", "description": description })} ${renderComponent($$result2, "Accordion", $$Accordion, {})} </div> ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Process.astro", void 0);
...
const propImg = new Proxy({"src":"/_astro/proposal-pic.DC7YnBHg.png","width":494,"height":395,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/assets/pics/proposal-pic.png";
							}
...
const $$Proposal = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Card", $$Card, {}, { "default": ($$result3) => renderTemplate` ${maybeRenderHead()}<div class="flex bg-[#F3F3F3] rounded-[45px] p-[60px] relative mt-[123px] mb-[163px]"> <div class="w-full md:w-[40%] flex flex-col gap-[26px]"> <h2 class="text-3xl font-medium">Ready to grow your brand online?</h2> <p>
Let's work together to build a strategy that puts your brand in front
          of the right people — at the right time.
</p> <a href="#contact" class="btn-primary inline-block w-fit">Get in Touch</a> </div> <picture class="hidden md:flex absolute right-[-10%] lg:right-0 top-[-15%] h-[450px] items-center justify-center"> ${renderComponent($$result3, "Image", $$Image, { "src": propImg, "alt": "Marketing strategy illustration", "class": "hidden md:flex lg:h-full lg:w-auto" })} </picture> </div> ` })} ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Proposal.astro", void 0);
...
const $$Services = createComponent(($$result, $$props, $$slots) => {
  ...
  const description = "From strategy to execution \u2014 here's how I help brands grow online.";
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "services" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mt-[140px] mb-5"> ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "What I Do", "description": description })} <div class="grid lg:grid-cols-2 lg:grid-rows-3 gap-10"> ${cards.map((card) => renderTemplate`${renderComponent($$result2, "ServiceCard", $$ServiceCard, { "index": card.index, "titleTop": card.titleTop, "titleBottom": card.titleBottom, "img": card.img, "alt": card.alt, "link": card.link })}`)} </div> </div> ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Services.astro", void 0);
...
const $$Sponsors = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "sponsors" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="flex-row items-center"> <div class="flex flex-wrap justify-center gap-3 md:gap-4"> ${skills.map((skill) => {
    return renderTemplate`<span class="px-5 py-2.5 rounded-full text-sm md:text-base font-medium bg-dark text-green border border-green/20 hover:bg-green hover:text-dark transition-all duration-300 cursor-default"> ${skill} </span>`;
  })} </div> </div> ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Sponsors.astro", void 0);
...
const $$Skills = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "skills" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mt-[140px] mb-5"> ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "Skills & Tools", "description": "The tools and techniques I use to build brands." })} <div class="space-y-8"> <!-- Industry Knowledge --> <div> <h3 class="text-lg font-medium mb-4 text-dark/70">Industry Knowledge</h3> <div class="flex flex-wrap gap-3"> ${industrySkills.map((skill) => renderTemplate`<span class="px-6 py-3 rounded-full text-base font-medium bg-dark text-green border border-dark hover:bg-green hover:text-dark transition-all duration-300 cursor-default shadow-[0px_3px_0px_#191a23]"> ${skill} </span>`)} </div> </div> <!-- Tools & Technologies --> <div> <h3 class="text-lg font-medium mb-4 text-dark/70">Tools & Technologies</h3> <div class="flex flex-wrap gap-3"> ${tools.map((tool) => renderTemplate`<span class="px-6 py-3 rounded-full text-base font-medium bg-green text-dark border border-dark hover:bg-dark hover:text-green transition-all duration-300 cursor-default shadow-[0px_3px_0px_#191a23]"> ${tool} </span>`)} </div> </div> </div> </div> ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Skills.astro", void 0);

const $$Team = createComponent(($$result, $$props, $$slots) => {
  const stats = [
    { value: "9+", label: "Months", sub: "Professional Experience" },
    { value: "2", label: "Certifications", sub: "Digital Marketing & Graphic Design" },
    { value: "500+", label: "Connections", sub: "LinkedIn Network" }
  ];
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "about" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="mt-[140px]"> ${renderComponent($$result2, "SectionTitle", $$SectionTitle, { "sectionTitle": "About Me", "description": "Get to know the person behind the brand." })} <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start"> <!-- Left Column: Photo + Name --> <div class="flex flex-col items-center lg:items-start gap-6"> <div class="w-64 h-64 rounded-full bg-gradient-to-br from-green to-dark flex items-center justify-center border-4 border-green overflow-hidden"> <img src="/Dihana1.webp" alt="Dihana Febin" class="w-full h-full object-cover"> </div> <div class="text-center lg:text-left"> <h3 class="text-2xl font-medium">Dihana Febin</h3> <p class="text-lg text-dark/70">Digital Marketer at Iberr Technologies LLP</p> <p class="text-sm text-dark/50 mt-1">Kerala, India</p> </div> <a href="https://www.linkedin.com/in/dihanafebin/" target="_blank" rel="noopener noreferrer" class="btn-primary inline-flex items-center gap-2"> <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"></path> </svg>
Connect on LinkedIn
</a> </div> <!-- Right Column: Bio + Stats --> <div class="flex flex-col gap-8"> <div class="space-y-4 text-base leading-relaxed"> <p>
...
</p> </div> <!-- Stats --> <div class="grid grid-cols-1 sm:grid-cols-3 gap-4"> ${stats.map((stat) => renderTemplate`<div class="bg-gray rounded-2xl p-5 text-center border border-dark/10 shadow-[0px_3px_0px_#191a23]"> <div class="text-2xl md:text-3xl font-medium text-dark"> ${stat.value} </div> <div class="text-sm font-medium text-dark mt-1">${stat.label}</div> <div class="text-xs text-dark/50 mt-1">${stat.sub}</div> </div>`)} </div> </div> </div> </div> ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Team.astro", void 0);

const testimonialsData = [
	{
		index: 1,
		name: "Marketing Manager",
		role: "Iberr Technologies LLP",
		comment: "Dihana's content strategy for our Instagram completely transformed our online presence. Her creativity and consistency are impressive for someone so early in their career."
	},
	{
		index: 2,
		name: "Client",
		role: "Iberr Technologies LLP",
		comment: "Working with Dihana on our Meta Ads campaign was a great experience. She's detail-oriented, proactive, and genuinely passionate about getting results."
	},
	{
		index: 3,
		name: "Team Member",
		role: "Iberr Technologies LLP",
		comment: "Dihana designed our social media graphics and the quality was outstanding. She understands both the design and the marketing side — a rare combination."
	}
];

const $$Testimonials = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Section", $$Section, { "id": "testimonials", "data-astro-cid-dnksfipb": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div class="testimonials-section mt-20 mb-[150px]" data-astro-cid-dnksfipb> <!-- Section Header — centered --> <div class="flex flex-col items-center gap-4 mb-16 text-center" data-astro-cid-dnksfipb> <h2 class="greenhead text-3xl sm:text-4xl" data-astro-cid-dnksfipb>Kind Words</h2> <p class="text-dark/60 max-w-md text-lg" data-astro-cid-dnksfipb>What people say about working with me.</p> </div> <!-- Testimonials Grid --> <div class="relative" data-astro-cid-dnksfipb> <!-- Decorative glow blobs --> <div class="absolute -top-16 -left-16 w-44 h-44 bg-green/8 rounded-full blur-[80px] pointer-events-none" data-astro-cid-dnksfipb></div> <div class="absolute -bottom-16 -right-16 w-52 h-52 bg-green/8 rounded-full blur-[80px] pointer-events-none" data-astro-cid-dnksfipb></div> <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8" data-astro-cid-dnksfipb> ${testimonialsData.map((item, index) => renderTemplate`<div${addAttribute([
    "testimonial-card group relative",
    index === 1 ? "md:mt-10" : ""
  ], "class:list")} data-astro-cid-dnksfipb>  <div class="relative h-full rounded-[32px] p-[1.5px] overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_8px_50px_rgba(185,255,102,0.12)] bg-gradient-to-br from-green/30 via-white/5 to-green/15 hover:from-green/60 hover:via-white/10 hover:to-green/40" data-astro-cid-dnksfipb>  <div class="relative h-full rounded-[31px] bg-dark p-8 sm:p-10 flex flex-col gap-7" data-astro-cid-dnksfipb>  <div class="flex items-start justify-between" data-astro-cid-dnksfipb> <svg class="w-9 h-9 text-green transition-colors duration-500 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor" data-astro-cid-dnksfipb> <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10H14.017zM0 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151C7.546 6.068 5.983 8.789 5.983 11H10v10H0z" data-astro-cid-dnksfipb></path> </svg> <span class="text-[72px] font-medium leading-none text-green/40 group-hover:text-green/70 transition-colors duration-500 select-none -mt-2" data-astro-cid-dnksfipb>
0${item.index} </span> </div>  <p class="text-white text-base sm:text-[17px] leading-[1.7] transition-colors duration-500 flex-grow" data-astro-cid-dnksfipb>
"${item.comment}"
</p>  <div class="w-full h-px bg-gradient-to-r from-green/40 via-green/15 to-transparent" data-astro-cid-dnksfipb></div>  <div class="flex items-center gap-4" data-astro-cid-dnksfipb>  <div class="w-11 h-11 rounded-full bg-gradient-to-br from-green via-green/80 to-green/50 flex items-center justify-center flex-shrink-0 group-hover:scale-110 group-hover:shadow-[0_0_20px_rgba(185,255,102,0.3)] transition-all duration-500" data-astro-cid-dnksfipb> <span class="text-dark font-medium text-xs tracking-wide" data-astro-cid-dnksfipb> ${item.name.split(" ").map((w) => w[0]).join("")} </span> </div> <div class="min-w-0" data-astro-cid-dnksfipb> <p class="text-green font-medium text-sm truncate" data-astro-cid-dnksfipb>${item.name}</p> <p class="text-white/40 text-xs mt-0.5 truncate" data-astro-cid-dnksfipb>${item.role}</p> </div> </div> </div> </div> </div>`)} </div> </div> <!-- Bottom decorative dots --> <div class="flex justify-center mt-14 gap-2" data-astro-cid-dnksfipb> ${[0, 1, 2].map((i) => renderTemplate`<div${addAttribute([
    "h-1.5 rounded-full bg-green transition-all duration-500",
    i === 1 ? "w-12 opacity-100" : "w-3 opacity-30"
  ], "class:list")} data-astro-cid-dnksfipb></div>`)} </div> </div> ` })}  ${renderScript($$result, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Testimonials.astro?astro&type=script&index=0&lang.ts")}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/sections/Testimonials.astro", void 0);

const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "MainLayout", $$MainLayout, { "title": "Dihana Febin \u2014 Digital Marketer | Kerala, India", "description": "Dihana Febin is a Digital Marketer at Iberr Technologies LLP, specializing in social media marketing, SEO, Meta Ads, and creative content strategy. Based in Kerala, India." }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Hero", $$Hero, {})} ${renderComponent($$result2, "Sponsors", $$Sponsors, {})} ${renderComponent($$result2, "Services", $$Services, {})} ${renderComponent($$result2, "Skills", $$Skills, {})} ${renderComponent($$result2, "Proposal", $$Proposal, {})} ${renderComponent($$result2, "Cases", $$Cases, {})} ${renderComponent($$result2, "Process", $$Process, {})} ${renderComponent($$result2, "Team", $$Team, {})} ${renderComponent($$result2, "Testimonials", $$Testimonials, {})} ${renderComponent($$result2, "Contact", $$Contact, {})} ` })}`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/pages/index.astro", void 0);

const $$file = "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/pages/index.astro";
const $$url = "";
