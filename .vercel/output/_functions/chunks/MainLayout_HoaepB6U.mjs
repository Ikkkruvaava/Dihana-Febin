import { c as createComponent, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, m as maybeRenderHead, r as renderComponent, d as addAttribute, b as createAstro, j as defineScriptVars, h as renderSlot, F as Fragment, k as renderHead, i as renderScript } from './astro/server_5S5MEE25.mjs';
import 'kleur/colors';
import './index_MaT6fT73.mjs';
import { $ as $$Image } from './_astro_assets_CNW_GREQ.mjs';
import 'clsx';
/* empty css                         */
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/ui/ShortForm.astro", void 0);

const $$Footer = createComponent(($$result, $$props, $$slots) => {
  const logos = [
    { name: "LinkedIn", src: Linkedin, link: "https://www.linkedin.com/in/dihanafebin/" },
  ...
  return renderTemplate`${maybeRenderHead()}<section class="sm:px-5"> <div class="w-full max-w-[1240px] mx-auto"> <div class="px-[15px] bg-dark text-gray py-[55px] lg:px-[60px] sm:rounded-t-[45px]"> <div> <div class="flex flex-col lg:flex-row gap-7 items-center justify-between"> <div class="flex flex-col items-center lg:items-start"> <a href="#home" class="text-2xl font-medium text-white">
Dihana Febin
</a> <span class="text-sm text-green mt-1">Strategy. Creativity. Results That Grow.</span> </div> <ul class="flex flex-col sm:flex-row gap-5"> ${links.map((link) => {
  ...
  })} </ul> </div> <div class="flex flex-col lg:flex-row mt-[66px] mb-[51px]"> <div class="flex text-center lg:text-start flex-col w-full lg:w-[30%]"> <h3 class="mb-5 text-center md:text-left text-2xl text-green">Get in Touch</h3> <div class="flex flex-col justify-between gap-4"> <span> Email: dihanafebin@gmail.com </span> <span> <a href="https://www.linkedin.com/in/dihanafebin/" target="_blank" class="underline">
LinkedIn: dihanafebin
</a> </span> <span>
Location: Kerala, India
</span> </div> </div> <div class="flex-grow my-10 lg:my-0 lg:ml-12"> ${renderComponent($$result, "ShortForm", $$ShortForm, {})} </div> </div> </div> <div class="h-[1px] bg-gray mb-5"></div> <div class="flex flex-col lg:flex-row h-20 justify-center mt-4 text-center md:justify-between md:mt-0"> <span>© 2025 Dihana Febin. All rights reserved.</span> </div> </div> </div> </section>`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/ui/Footer.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/Astronav.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/components/MenuIcon.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/components/OpenIcon.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/components/CloseIcon.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/components/MenuItems.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/components/Dropdown.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/components/DropdownSubmenu.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/components/DropdownItems.astro", void 0);
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/node_modules/astro-navbar/src/components/StickyHeader.astro", void 0);
...
const $$Navbar = createComponent(($$result, $$props, $$slots) => {
  ...
  const navButton = { href: "#contact", label: "Hire Me" };
...
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/components/seo/Seo.astro", void 0);
...
const $$MainHead = createComponent(($$result, $$props, $$slots) => {
  ...
  --><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>${title}</title><meta name="description"${addAttribute(description, "content")}><meta name="keywords" content="Digital Marketer Kerala, Social Media Marketing, SEO, Meta Ads, Content Strategy, Dihana Febin">${renderComponent($$result, "Seo", $$Seo, { "title": title, "description": description, "url": Astro2.url.toString(), "image": image, "frontmatter": frontmatter, "robots": robots })}<!-- Preconnect fonts, images... -->${renderHead()}</head>`;
}, "D:/Code/Web/Portfolio-Websites/Dihana/Positivus/src/layouts/MainHead.astro", void 0);
